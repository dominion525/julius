 ...
 * 
 * <EN>
 * @brief  Word trellis related operations
 *
 * Functions to store the result of the 1st pass as "word trellis", and
 * to access them from the 2nd pass is defined in this file.  On the
 * 1st pass of Julius, all the promising words whose word end has been
 * survived at the 1st pass will be stored as "word trellis", which
 * consists of trellis words that contains informations about the surviving
 * words: word boundary, accumulated score and word history.
 *
 * The trellis word will be stored per frame while recognition on the 1st pass.
 * After the 1st pass ended, the word trellis will be re-formed and
 * indexed by the frames to prepare for the access from the 2nd pass.
 *
